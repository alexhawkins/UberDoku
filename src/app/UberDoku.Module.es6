...
* **********************************************
* Description: the container module for all other
* modules where the main components/modules of 
* the game are instantiated.
/*---------------------------------------------*/
...
class UberDoku {
    ...
    ********************************************/
    ...
    /********************************************
    * UberDoku.Prototype.intialize is a prototype Fn
    * that allows us to initialize specific vars
    * and methods upon class instantiation.
    ********************************************/
